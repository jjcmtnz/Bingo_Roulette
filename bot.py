...
SPECTATOR_QUIPS = [
    ...
    "Bingo Betty fans herself. Not impressed—yet.",
    "Spectators pretend this was part of the plan.",
    "A hush falls over the audience. Then, a yawn.",
    "Even the bingo balls are rolling their eyes.",
    "Someone whispers, *“finally.”*",
]

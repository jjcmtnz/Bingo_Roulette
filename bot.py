...
{"> " + "\n> ".join(bonus_challenges[board_letter].replace("/n", "\n").splitlines())}
...
async def intro(ctx):
    ...
    msg = (
        ...
        "- You will work on one board at a time. After you complete every tile on one board, "
        ...
        "!tile# — marks your tile as complete (e.g., !tile3) use after completing the tile\n\n"
        "!finishbonus — complete the Bonus Tile and advance\n\n"
        "!skipbonus — skip the Bonus Tile and advance\n\n"
        "📜 Points\n\n"
        ...
        "Please only use the bot when necessary; do not abuse it.\n\n"
        "Use !progress, !points, and !commands to see your status, your current points, "
        "and a list of available commands.\n\n"
        "All drops must be posted in the drops channel. Please refer to the rules channel for "
        "screenshot guidelines. Please pay close attention to the specifics regarding kc pity, "
        "minigames, and other tile-specific requirements.\n\n"
        "Please be respectful, kind, and courteous to your teammates and refs. "
        "Keep it positive, grind hard, have fun, and for the love of Betty, "
